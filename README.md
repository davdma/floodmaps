...
<div align="center">
<img width="80%" alt="labelmapwtile_updated_final" src="https://github.com/user-attachments/assets/b5ed7fa4-a605-4849-9df5-a288bee81c42" />
<p style="width: 60%; margin: 0 auto;"><em>Figure 2.3: Map of manually labeled tiles which can be grouped into an Illinois centric dataset (red pins), Texas centric dataset (blue pins), and other (green pins). The "Other" grouping consists of many edge cases (haze, clouds, cloud shadows) and non-flood urban tiles used to improve generalization of the model across diverse scene conditions.
</em></p>
</div>
