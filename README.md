...
As a result, we were able to produce 111+ 4km 4km manually labeled flood tiles spread across the Illinois/Wisconsin/Indiana and Texas/Florida regions. This does not include the hundreds of additional weak labels (generated by the best trained model on unlabeled data) used to augment the datasets for iterative model training and development.
