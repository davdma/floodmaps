...
def benchmark_sar(cfg: DictConfig) -> None:
    ...
    cfg.train.shift_invariant : bool
        Whether shift invariance is used (determines partition for metrics)
    ...
    SAR-specific: Uses partition='shift_invariant' or 'non_shift_invariant' based
    on cfg.train.shift_invariant setting when extracting metrics.
    """
