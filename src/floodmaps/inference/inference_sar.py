...
def main(cfg, format="tif", replace=True, data_dir=""):
    """Generates machine labels for dataset using S2 or S1 model.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='inference_sar', description='Generate s1 model predictions for specific area of interest.')
    ...
    parser.add_argument('--data_dir', default='samples_200_6_4_10_sar/', help='directory with rasters to make predictions in (default: samples_200_6_4_10_sar/)')
